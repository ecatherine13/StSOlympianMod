...
public class CloudedJudgementPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = DefaultMod.makeID("CloudedJudgementPower");
    ...
    public CloudedJudgementPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    // None. Check for this power when using Aid cards
    ...
    public AbstractPower makeCopy() {
        return new CloudedJudgementPower(owner, source, amount);
    }
}
