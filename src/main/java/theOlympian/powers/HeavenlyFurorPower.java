...
public class HeavenlyFurorPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = DefaultMod.makeID("HeavenlyFurorPower");
    ...
    public HeavenlyFurorPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    // trigger methods
    // None. This is only checked when an Aid card is used
    ...
    public AbstractPower makeCopy() {
        return new HeavenlyFurorPower(owner, source, amount);
    }
}
