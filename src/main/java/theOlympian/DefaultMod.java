...
import theOlympian.cards.*;
import theOlympian.characters.TheDefault;
import theOlympian.events.IdentityCrisisEvent;
import theOlympian.potions.PlaceholderPotion;
import theOlympian.relics.*;
import theOlympian.util.IDCheckDontTouchPls;
import theOlympian.util.TextureLoader;
import theOlympian.variables.DefaultCustomVariable;
import theOlympian.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String ATTACK_DEFAULT_GRAY = "theOlympianResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "theOlympianResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "theOlympianResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "theOlympianResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "theOlympianResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "theOlympianResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "theOlympianResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "theOlympianResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "theOlympianResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "theOlympianResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "theOlympianResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "theOlympianResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "theOlympianResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "theOlympianResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "theOlympianResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "theOlympianResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "theOlympianResources/images/char/defaultCharacter/skeleton.json";
...
//        BaseMod.addRelicToCustomPool(new DefaultClickableRelic(), TheDefault.Enums.COLOR_GRAY);
        BaseMod.addRelicToCustomPool(new ThunderSignet(), TheDefault.Enums.COLOR_GRAY);
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("OlympianMod") // ${project.artifactId}
